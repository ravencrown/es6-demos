...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _stringTemp = __webpack_require__(299);

	var _stringTemp2 = _interopRequireDefault(_stringTemp);
...
/***/ (function(module, exports) {
...

	{
	    ...
	    var array = [{ first: 'Jane', last: 'Bond' }, { first: 'Lars', last: 'Croft' }];

	    // forEach
	    var forEachTmpl = function forEachTmpl(data) {
	    ...
	    var ifTmpl = function ifTmpl(data) {
	        return '\n        ' + (data && data == true && '\n            <div style=\'font-size:20px;\'>GOOD<div>\n        ') + '\n    ';
	    };

	    $(".demo").append(ifTmpl(flag));

	    var array2 = [{ key: 'tmpl', value: 'foo' }, { key: 'tmpl', value: 'bar' }, { key: 'tmpl22', value: 'baz' }];

	    var sanmuTmpl = function sanmuTmpl(data) {
	        return '\n        ' + data.map(function (item) {
	    ...
	    var multiForEachTmpl = function multiForEachTmpl(data) {
	        return '\n        ' + data.map(function (item) {
	            return '\n            <table class="table-border">\n                <caption>' + item.groupName + '</caption>\n                <tbody>\n                    ' + (item.atts && item.atts != '' && '\n                        ' + item.atts.map(function (attsItem) {
	                return '\n                            ' + attsItem.valLables.map(function (trItem) {
	                    return '\n                                <tr>\n                                    <td>' + trItem.label + '</td>\n                                    <td>' + trItem.value + '</td>\n                                </tr>\n                            ';
	                }).join('') + '\n                        ';
	            }).join('') + '\n                    ') + '\n                </tbody>\n            </table>\n        ';
	        }).join('') + '\n    ';
